            ...
            <div className="mt-2 inline-flex justify-content gap-2">
                {addedPhotos.length > 0 && addedPhotos.map(link => (
                    <div className="h-32 flex relative" key={link}>
                        <img className="object-cover rounded-2xl w-full object-cover" src={`${baseAPIPath}/uploads/` + link} alt="" />
                        ...
                        <button onClick={(ev) => selectAsMainPhoto(ev, link)} className="cursor-pointer absolute bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3">
                            ...
                            {
                                link !== addedPhotos[0] && (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
